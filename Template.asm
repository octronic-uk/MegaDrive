...
; Header Section ---------------------------------------------------------------
	...
	dc.b    "Ash's Game                                      " ; Domestic name
	dc.b    "Ash's Game                                      " ; International name
...
_VDPInitCopy:
    ...
    move.w  d1,VDP_CRTL_PORT    ; Write command and value to VDP control port
